  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'pythran-0.11.0-py310ha912908_1.tar.bz2.data';
      var REMOTE_PACKAGE_BASE = 'pythran-0.11.0-py310ha912908_1.tar.bz2.data';
...
;
            ...
            Module['removeRunDependency']('datafile_pythran-0.11.0-py310ha912908_1.tar.bz2.data');
      };
      Module['addRunDependency']('datafile_pythran-0.11.0-py310ha912908_1.tar.bz2.data');
