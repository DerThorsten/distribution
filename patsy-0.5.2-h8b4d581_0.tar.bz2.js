  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'patsy-0.5.2-h8b4d581_0.tar.bz2.data';
      var REMOTE_PACKAGE_BASE = 'patsy-0.5.2-h8b4d581_0.tar.bz2.data';
...
;
            ...
            Module['removeRunDependency']('datafile_patsy-0.5.2-h8b4d581_0.tar.bz2.data');
      };
      Module['addRunDependency']('datafile_patsy-0.5.2-h8b4d581_0.tar.bz2.data');
